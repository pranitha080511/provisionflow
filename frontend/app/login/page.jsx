  ...
  return(
    ...
    <div className="flex items-center justify-center min-h-screen bg-black text-white">
      ...
      <form
        ...
        className="bg-gray-900 border border-gray-800 p-10 rounded-xl w-96 shadow-xl"
      >
        ...
        <input
          ...
          autoComplete="off"
          className="border border-gray-700 bg-black p-3 w-full mb-6 rounded-lg text-white focus:border-purple-500 focus:outline-none"
